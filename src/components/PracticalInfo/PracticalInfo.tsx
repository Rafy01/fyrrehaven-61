    ...
    return (
      <>
        ...
        <div className={styles.texts}>
          <div className={styles.itemTitle}>{t(it.titleDa, it.titleEn)}</div>
          <div className={styles.itemSub}>{t(it.textDa, it.textEn)}</div>
        </div>
      </>
    );
  };
        ...
        {list.map((it) => {
          ...
          return (
            <div
              ...
              className={styles.card}
              role="group"
              aria-label={t(it.titleDa, it.titleEn)}
            >
              {renderCardInner(it)}
            </div>
          );
        ...
        <div className={styles.cta}>
          {ctaTo ? (
            <Link to={ctaTo} className={styles.ctaBtn}>
              {t(ctaLabelDa ?? "Læs mere", ctaLabelEn ?? "Learn more")}
            </Link>
          ) : (
            <a
              href={ctaHref}
