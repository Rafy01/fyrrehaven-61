...
export default function GalleryPage({ lang }) {
    ...
    const seoTitle = t("Galleri – billeder af hus, pool og omgivelser", "Gallery – photos of the house, pool and surroundings");
    const seoDescription = t("Se billeder af stue, køkken-alrum, soveværelser og hems – plus udendørs opvarmet pool (1. maj–1. oktober), brændefyret vildmarksbad, el-sauna og nærliggende skov og strand ved Fjellerup. Få et ærligt indtryk.", "Browse photos of the living room, kitchen-diner, bedrooms and loft — plus the heated outdoor pool (May 1–Oct 1), wood-fired hot tub, electric sauna and nearby forest and beach in Fjellerup. Get a true feel for the place.");
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Head, { lang: lang, path: path, title: seoTitle, description: seoDescription, ogImage: "https://media.fyrrehaven-61.dk/wp-content/uploads/2025/09/ogimage2.jpg", jsonLd: jsonLd, robots: { index: true, follow: true, noarchive: true }, keywords: seoKeywords }), _jsx(Hero, { title: t("Galleri", "Gallery"), subtitle: t("Få fornemmelsen af stedet – klik et billede for fuld størrelse.", "Get a feel for the place — click any photo to view full size."), badges: [
                ...
                }, align: "left", layout: "media-right" }), _jsx(Container, { size: "3", id: "grid", children: _jsx(Box, { py: "6", children: _jsx("div", { className: styles.albumGrid, children: albums.map(({ id, label }) => (_jsxs("figure", { className: styles.albumCard, children: [_jsx("div", { className: styles.thumbClamp, children: _jsx(Gallery, { lang: lang, items: galleryItemsFromAlbum(id), maxItems: 1, tile: { width: 260, height: 420 }, fit: "cover" }) }), _jsx("figcaption", { className: styles.albumCaption, children: label })] }, id))) }) }) })] }));
}
