...
export const SNIPPETS = [
     ...
     * ========================= */
    {
        ...
        bodyDa: "**Ja, du kan sende en privat booking-forespørgsel via hjemmesiden.**\n\n" +
            "Vi har både Airbnb og privat forespørgsel. Ved privat booking bekræfter vi pr. mail og sender lejekontrakt.",
        bodyEn: "**Yes, you can send a private booking request on our website.**\n\n" +
    ...
    },
    {
        ...
        bodyDa: "**Ingen fester/arrangementer.** Minimumsalder for ansvarlig lejer er **25 år**. Tak for forståelsen 🌿",
        bodyEn: "**No parties or events.** The minimum age for the responsible renter is **25 years**. Thanks for understanding 🌿",
     ...
     * ========================= */
    {
        ...
        bodyDa: "Standard: **Check-in kl. 16** / **Check-out kl. 10**.\n\n" +
        ...
        bodyEn: "Standard: **Check-in 16:00** / **Check-out 10:00**.\n\n" +
    ...
    },
    {
        ...
        titleDa: "Nøgleboks",
        titleEn: "Key box",
        bodyDa: "Nøgleboksen er **til højre for hoveddøren**. Koden udsendes **1 time før** indtjekning.",
        bodyEn: "The key box is **to the right of the front door**. The code is sent **1 hour before** check-in.",
     ...
     * ========================= */
    {
        ...
        bodyDa: "El og vand afregnes **efter forbrug** via **bankoverførsel efter opholdet**.\n\n" +
            "Forventningsniveau: el **" + L.approxDa + " 200–250 DKK/dag**, vand **" + L.approxDa + " 50 DKK/dag** (afhængigt af sæson/brug).",
        bodyEn: "Electricity and water are **billed by usage**, paid via **bank transfer after your stay**.\n\n" +
    ...
    },
    {
        ...
        bodyDa: "Ved ankomst **aflæs el- og vandmåler** og **upload et foto** via link i vores beskeder/ved indgangen til huset.",
        bodyEn: "On arrival, please **read the electricity and water meters** and **upload a photo** via the link in our messages/at the house entrance.",
    ...
    },
    {
        ...
        titleEn: "EV charging",
        bodyDa: "**Type 2**. Medbring **eget kabel**. Forbrug **indgår i el-afregningen**.",
        bodyEn: "**Type 2**. Bring **your own cable**. Usage **is part of the electricity billing**.",
     ...
     * ========================= */
    {
        ...
        bodyDa: "**Sengetøj**: DKK 75 pr. person\n\n" +
            ...
            "**Træ & optænding** (pr. net ca. 22 L): DKK 100\n\n" +
        ...
        bodyEn: "**Bed linen**: DKK 75 per person\n\n" +
            ...
            "**Firewood & kindling** (per ~22 L bag): DKK 100\n\n" +
     ...
     * ========================= */
    {
        ...
        titleDa: "Husregler",
        titleEn: "House rules",
        bodyDa: "• **Ingen fester**, ingen rygning indendørs, **25+ år** for ansvarlig lejer.\n\n" +
            "• **Adgang forbudt** i **anneks** og **skur**, samt **pool-teknik**.\n\n" +
            "• **Stilleperiode**: **22–06**. Vis hensyn til naboer 🌙",
        bodyEn: "• **No parties**, no indoor smoking, **25+ years** for responsible renter.\n\n" +
     ...
     * ========================= */
    {
        ...
        titleDa: "Sikkerhed",
        titleEn: "Safety",
        bodyDa: "• **Røgalarm + kuliltealarm (Nest)** i køkken/alrum – sender også besked til os.\n\n" +
            "• **Førstehjælpskasse**: på **køkkenøen**.\n\n" +
            "• **Pool/vildmarksbad/sauna** – læs venligst vores retningslinjer før brug.",
        bodyEn: "• **Smoke + CO alarm (Nest)** in the kitchen/living area – notifies us as well.\n\n" +
    ...
    },
    {
        ...
        bodyDa: "**Chromecast** med adgang til alle apps—brug dit eget login, hvis tjenesten kræver det. Ingen flow-TV inkluderet.",
        bodyEn: "**Chromecast** with access to all apps—use your own logins if required. No linear TV included.",
     ...
     * ========================= */
    {
        ...
        bodyDa: "**Babyseng** (gratis, bestilles) – **højstol** (gratis, bestilles).\n\n" +
            "Vi har **børneservice**. Rejseseng leveres **inkl. madras og lagen**.",
        bodyEn: "**Baby cot** (free, pre-order) – **high chair** (free, pre-order).\n\n" +
    ...
    },
    {
        ...
        bodyDa: "**Opvaskemaskine**, **ovn**, **mikroovn**. **Kaffemaskine (bønner)** – en pose bønner er inkluderet.\n\n" +
            "**Sodastream**: 2 cylindre (1 i brug + 1 ekstra). **Startpakke** med basale forbrugsvarer.",
        bodyEn: "**Dishwasher**, **oven**, **microwave**. **Coffee machine (beans)** – one bag of beans included.\n\n" +
     ...
     * ========================= */
    {
        ...
        titleDa: "Gasgrill",
        titleEn: "Gas grill",
        bodyDa: "**Gasgrill**: gas inkluderet + **ekstra flaske** på stedet. **Gæster rengør efter brug.**",
        bodyEn: "**Gas grill**: gas included + **spare bottle** on site. **Guests clean after use.**",
    ...
    },
    {
        ...
        bodyDa: "**Brug på eget ansvar** og **med opsyn**.\n\n" +
            "Trampolin, gynge og legetårn i haven.",
        bodyEn: "**Use at your own risk** and **with supervision**.\n\n" +
    ...
    },
    {
        ...
        bodyDa: "**Udelys hele vejen rundt**. Kan tændes ved TV’et (delvist også sensorsstyret).",
        bodyEn: "**Outdoor lights all around**. Can be switched near the TV (partly sensor-controlled).",
    ...
    },
    {
        ...
        titleDa: "Parkering",
        titleEn: "Parking",
        bodyDa: "**Gratis parkering** på grus **lige ved huset** (ikke på græs). Ca. **6 pladser**.",
        bodyEn: "**Free parking** on gravel **right by the house** (no parking on grass). About **6 spaces**.",
     ...
     * ========================= */
    {
        ...
        bodyDa: "**Fjellerup Strand**: " + L.approxDa + " 0,9 km\n\n" +
        ...
        bodyEn: "**Fjellerup Beach**: " + L.approxEn + " 0.9 km\n\n" +
     ...
     * ========================= */
    {
        ...
        bodyDa: "Ved akutte problemer: **skriv på mail, SMS eller via Airbnb** – vi svarer typisk **under 1 time**.",
        bodyEn: "For urgent issues: **email, SMS or via Airbnb** – we typically respond **within 1 hour**.",
