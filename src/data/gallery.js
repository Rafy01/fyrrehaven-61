...
export function galleryItemsFromAlbum(id) {
    const a = getAlbum(id);
    if (!a)
        return [];
    ...
    /* --------------------------------- Indoor ---------------------------------- */
    {
        ...
        items: [
            ...
            },
            {
                ...
                altEn: "Bedroom with terrace access, fold-down desk and external monitor",
            },
            {
                src: u("IMG_3672.webp"),
    ...
    /* ----------------------------------- Area ---------------------------------- */
    {
        ...
        items: [
            ...
            },
            {
                ...
                altEn: "Evening sun by the coast – dunes and beach within walking distance",
            },
            {
                src: u("IMG_3773.webp"),
            ...
            },
            {
                ...
                altEn: "Forest path within walking distance of Fyrrehaven 61 – Fjellerup",
            },
            {
                src: u("IMG_3663.webp"),
