...
const ATTRACTION_DATA = [
    /* ---------- Forlystelser / Parks ---------- */
    {
        ...
        descEn: "Scandinavia’s largest amusement park with 60+ rides and water park.",
        tags: ["parks", "kids"],
    ...
    /* ---------- Kultur ---------- */
    {
        ...
        descEn: "Iconic castle ruin in Kalø Bay – scenic walk on the old stone road.",
        tags: ["culture", "nature"],
...
export const ATTRACTIONS = ATTRACTION_DATA.map((a) => ({
    id: a.id,
    titleDa: a.titleDa,
    titleEn: a.titleEn,
    descDa: a.descDa,
