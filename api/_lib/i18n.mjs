const resources = {
  da: {
    ...
    contact: {
      ...
      totalAfterDiscount: "Estimeret total efter rabat",
      priceNights: "Pris (overnatninger)",
      cleaning: "Rengøring",
      airbnbServiceFeeSavings: "Direkte booking-rabat (-14,2 %)",
      guests: "Gæster",
      adults: "Voksne",
      children: "Børn",
      babies: "Babyer",
  ...
  en: {
    ...
    contact: {
      ...
      totalAfterDiscount: "Estimated total after discount",
      priceNights: "Price (nights)",
      cleaning: "Cleaning",
      airbnbServiceFeeSavings: "Direct booking discount (-14.2%)",
      guests: "Guests",
      adults: "Adults",
      children: "Children",
      babies: "Babies",
  ...
  de: {
    ...
    contact: {
      ...
      totalAfterDiscount: "Geschätzter Gesamtpreis nach Rabatt",
      priceNights: "Preis (Nächte)",
      cleaning: "Reinigung",
      airbnbServiceFeeSavings: "Direktbucher-Rabatt (-14,2 %)",
      guests: "Gäste",
      adults: "Erwachsene",
      children: "Kinder",
      babies: "Babys",
